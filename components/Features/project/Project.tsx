...
export function Projects() {
  ...
  const projects: Project[] = [
    { id: 1, title: "Portfolio Website",         category: "Web",    image: "/portfoliowebsite.Jpg",     description: "A personal portfolio website showcasing my skills, projects, and experience as a developer." },
